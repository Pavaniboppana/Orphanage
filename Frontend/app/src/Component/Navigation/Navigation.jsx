          ...
          <Nav className="me-auto">
            ...
            <Nav.Link as={Link} to="/about">About Us</Nav.Link>
             ...
             <NavDropdown title="Facilities" id="nav-dropdown">
              <NavDropdown.Item as={Link} to="/food">Home Care</NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/donate">Adult Care</NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/events">Assisted Living</NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/donate">Nursing Home</NavDropdown.Item>
            </NavDropdown>
